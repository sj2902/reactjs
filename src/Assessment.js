...
const WebcamStreamCapture = () => {
  ...
  //           const user = authentication.currentUser;
    ...
    const [recordCounter, setRecordCounter] = useState(20);
      ...
      uploadTask.on(
        ...
        () => {
          getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
            ...
            const docRef = doc(db, "VideoInput", "Wytj42j4GEA42zboS7X4");
            setDoc(docRef, {[sign] : downloadURL});

            const colRef = doc(db, "VideoOutput", "Wytj42j4GEA42zboS7X4");
